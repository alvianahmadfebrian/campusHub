...
function cancelEdit() {
  ...
  form.jurusan_id = props.profile?.jurusan_id || "";
  form.semester = props.profile?.semester || "";
  form.telepon = props.profile?.telepon || "";
...
=======
          <div class="profile-hero-actions">
            ...
            <template v-else>
              ...
              <button class="ph-btn ph-btn-ghost" @click="cancelEdit">
                Batal
              </button>
            </template>
          </div>
        ...
        <div class="profile-col-left">
          <div class="pcard">
            ...
            >
              <li
                v-for="item in [
                  { label: 'Nama lengkap', val: profile?.nama },
                  { label: 'NIM', val: profile?.nim },
                  { label: 'Jurusan', val: profile?.jurusan_nama },
                  { label: 'Semester', val: profile?.semester },
                  { label: 'Foto profil', val: profile?.avatar_url },
                  { label: 'Nomor telepon', val: profile?.telepon },
                  { label: 'Alamat', val: profile?.alamat },
                  { label: 'Email pribadi', val: profile?.email },
                ]"
                :key="item.label"
                style="
                  display: flex;
              ...
              >
                <span
                  :style="{
                    ...
                    display: 'grid',
                    placeItems: 'center',
                    background: item.val ? '#ccfbf1' : 'var(--border)',
                    color: item.val ? 'var(--primary)' : 'var(--muted)',
                  }"
                >
                  <svg
                    v-if="item.val"
                ...
                <span
                  :style="{ color: item.val ? 'var(--text)' : 'var(--muted)' }"
                  >{{ item.label }}</span
                >
              </li>
            </ul>

            <!-- CTA kalau belum lengkap -->
            <button
              v-if="
                !editMode &&
                [
        ...
        <div class="profile-col-right">
          ...
          <div class="pcard">
            ...
            <!-- Form Edit -->
              ...
              <div class="ph-form-row">
                <label class="ph-label">Nomor Telepon</label>
                <input
              ...
              <div class="ph-form-row">
                ...
                <input
                  ...
                  pattern="[a-zA-Z0-9._%+\-]+@(gmail\.com|icloud\.com|yahoo\.com|outlook\.com)"
                />
                <p v-if="form.errors.email" class="error">
                  {{ form.errors.email }}
                </p>
              </div>
              <div class="ph-form-row" style="grid-column: 1 / -1">
                <label class="ph-label">Alamat</label>
                <textarea
                  v-model="form.alamat"
                  class="ph-input"
                  rows="3"
            ...
            <div class="info-grid">
              <div class="info-item">
                ...
                <p class="info-val icon-row">
                  ...
                  {{
                    profile?.nim
                      ? profile.nim.toLowerCase() + "@student.campushub.ac.id"
                      : "—"
                  }}
                </p>
              </div>
              ...
              <div class="info-item">
                ...
                <p class="info-val icon-row">
                  ...
                  >
                    <path
                      d="M22 16.92v3a2 2 0 0 1-2.18 2A19.72 19.72 0 0 1 3.08 4.18 2 2 0 0 1 5.07 2h3a2 2 0 0 1 2 1.72 12.05 12.05 0 0 0 .67 2.81 2 2 0 0 1-.45 2.11L9.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.05 12.05 0 0 0 2.81.67A2 2 0 0 1 23 16.92z"
                    />
                  </svg>
                  {{ profile?.telepon || "—" }}
                </p>
